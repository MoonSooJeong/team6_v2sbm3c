  ...
  <table class="table table-hover">
    ...
    <tbody>
        <c:forEach var="informationVO" items="${list }" varStatus="info">
          ...
          <tr onclick="location.href='./read.do?informationno=${informationno}&word=${param.word }&now_page=${param.now_page == null ? 1 : param.now_page }&sectno=${param.sectno }'" style="cursor: pointer;">
            <td>
              <c:choose>
