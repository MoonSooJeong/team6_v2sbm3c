...
<c:import url="/menu/top.do" />
  ...
  <DIV class='title_line'><A href="/information/list_by_sectno.do?sectno=${sectVO.sectno }" class="title_link">${sectVO.name }</A> > ${informationVO.title } > 지도 등록/수정/삭제</DIV>
  ...
  <FORM name='frm_map' method='post' action='./map.do'>
    ...
    <div>
       <label>지도 스크립트</label>
       <textarea name='map' class="form-control" rows="12" style='width: 100%;'>${informationVO.map }</textarea>
    </div>
