  ...
  <table class="table table-hover">
    ...
    <tbody>
        <c:forEach var="contentsVO" items="${list }" varStatus="info">
          ...
          <tr onclick="location.href='./read.do?contentsno=${contentsno}&now_page=1'" style="cursor: pointer;">
            <td>
              <c:choose>
            ...
            <td class="td_bs">
              <a href="#" title="지도"><img src="/contents/images/map.png" class="icon"></a>
              <a href="#" title="유튜브"><img src="/contents/images/youtube.png" class="icon"></a>
