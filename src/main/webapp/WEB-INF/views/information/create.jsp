...
<c:import url="/menu/top.do" />
  ...
  <form name='frm' method='post' action='./create.do' enctype="multipart/form-data">
    ...
    <div>
       <label>내용</label>
       <textarea name='content' required="required" class="form-control" rows="12" style='width: 100%;'>추천 내용을 작성하세요 </textarea>
    </div>
    <div>
       <label>검색어</label>
       <input type='text' name='word' value='검색태그 작성' required="required" 
