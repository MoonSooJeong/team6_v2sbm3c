  ...
  <fieldset class='fieldset_basic'>
    <UL>
      ...
      <li class='li_none'>
        ...
        <button type='button' onclick="location.href='./create.do?'" class="btn btn-secondary btn-sm">새로운 공지사항 등록</button>
        <button type='button' onclick="location.href='./list_by_all.do?'" class="btn btn-secondary btn-sm">목록</button>
      </li>
    </UL>
  </fieldset>
