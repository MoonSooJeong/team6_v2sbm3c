...
public class ContentsProc implements ContentsProcInter {
  ...
  @Override
  public ArrayList<ContentsVO> list_by_sectno(int sectno) {
    ArrayList<ContentsVO> list = this.contentsDAO.list_by_sectno(sectno);
    return list;
  }
  ...
  @Override
  public ArrayList<ContentsVO> list_by_sectno_search(HashMap<String, Object> hashMap) {
    ArrayList<ContentsVO> list = this.contentsDAO.list_by_sectno_search(hashMap);
    return list;
  }
  ...
  @Override
  public ArrayList<ContentsVO> list_by_sectno_search_paging(ContentsVO contentsVO) {
    /*
    예) 페이지당 10개의 레코드 출력
    ...
    */
    ...
    ArrayList<ContentsVO> list = this.contentsDAO.list_by_sectno_search_paging(contentsVO);
...
//  
//  <DIV id='paging'>
//    <span class='span_box_1'><A href='list_by_sectno.do?word=&now_page=1&sectno=4'>1</A></span>
//  <span class='span_box_2'>2</span>
//  <span class='span_box_1'><A href='list_by_sectno.do?word=&now_page=3&sectno=4'>3</A></span>
//    </DIV>
//  </DIV> 
//  <!-- 페이지 목록 출력 부분 종료 -->
...
//      str.append("현재 페이지: " + nowPage + " / " + totalPage + "  "); 
    ...
    public int count_by_sectno(int sectno) {
      int cnt = this.contentsDAO.count_by_sectno(sectno);
      return cnt;
    }
    
    @Override
    public int delete_by_sectno(int sectno) {
      int cnt = this.contentsDAO.delete_by_sectno(sectno);
      return cnt;
    }
